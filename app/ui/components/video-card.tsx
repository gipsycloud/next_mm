        ...
        <div className="border w-96 rounded-lg shadow-md bg-white dark:bg-gray-800 dark:border-gray-700 m-5">
            ...
            <div className="relative inline-block">
                ...
                <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">{video.channelName}</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{video.views} views • {video.uploadDate}</p>
                </div>

                <div className="ml-3">
                    <Button as={Link} href={`/watch/${video.videoId}`}>Watch</Button>
                </div>
            </div>
        </div>
    )
